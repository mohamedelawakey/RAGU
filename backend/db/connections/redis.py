...
class AsyncRedisDBConnection:
    ...
    async def get_connection(
        ...
        """
        Obtain a singleton asynchronous Redis client, initializing a connection pool and retrying pings until successful.
        
        Parameters:
            retries (int): Maximum number of connection attempts before failing.
            retry_delay (float): Seconds to wait between retry attempts.
        
        Returns:
            Redis: A connected Redis client instance tied to the module-level connection pool.
        
        Raises:
            ConnectionError: If unable to establish a Redis connection after `retries` attempts.
        """
